...
/**
 *Gateway para comunicarse con Authenticus
 */
public class AuthenticusGateway {
    ...
    public UserDTO signup(UserDTO user) {
        try {
            ...
            System.err.println("Signup failed with status: " + response.statusCode() + " - " + response.body());
            return null;
        } catch (Exception e) {
    ...
    public AuthTokenDTO login(LoginDTO credentials) {
        try {
            ...
            // 401 = wrong credentials, 409 = already logged in
    ...
    public boolean removeUser(Integer userId) {
        ...
        try {
            ...
            System.err.println("Error in removeUser: " + e.getMessage());
            return false;
        }
    }
    ...
    public CaseDTO createCase(CaseDTO caseData, String token) {
        ...
        try {
            ...
            System.err.println("Create case failed with status: " + response.statusCode() + " - " + response.body());
            return null;
        } catch (Exception e) {
    ...
    public String myCases(String token, int numberCases, LocalDate fechaInicio, LocalDate fechaFin) {
        ...
        try {
            ...
            return "Error getting cases: " + response.statusCode();
        } catch (Exception e) {
            System.err.println("Error in myCases: " + e.getMessage());
    ...
    public String getCaseResult(String token, String caseName) {
        ...
        try {
            ...
            System.err.println("Error in getCaseResult: " + e.getMessage());
            return "";
        }
    }
    ...
    public boolean addFiles(String token, Integer caseId, List<FileDTO> files) {
        ...
        try {
            ...
            System.err.println("Error in addFiles: " + e.getMessage());
            return false;
        }
    }
    ...
    public String analyzeCase(String token, String caseName) {
        ...
        try {
            ...
            System.err.println("Error in analyzeCase: " + e.getMessage());
            return "Error: " + e.getMessage();
        }
    }
}
